...
//   return (
//     <div className="h-screen flex bg-base-200 overflow-hidden" ref={containerRef}>
//       {/* Sidebar visible on desktop or mobile if no chat selected */}
...
//       {/* Draggable divider only on desktop */}
//       {!isMobile && (
//         <div
//           ref={resizerRef}
...
const HomePage = () => {
  ...
  return (
    <div className="relative h-screen flex bg-base-200 overflow-hidden" ref={containerRef}>
      {/* ConfirmBar overlays everything */}
      <ConfirmBar />
